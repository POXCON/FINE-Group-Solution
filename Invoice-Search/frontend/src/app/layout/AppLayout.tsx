        ...
        <aside className="flex min-h-full w-72 flex-col bg-neutral text-neutral-content">
          ...
          <div className="border-t border-white/10 p-3">
            ...
            <div className="mt-2 flex items-center gap-2">
              <button
                type="button"
                className="flex flex-1 items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-neutral-content/80 transition-colors hover:bg-white/5 hover:text-white"
                onClick={toggleTheme}
              ...
              >
                ...
                <span>{theme === "light" ? t("common.dark") : t("common.light")}</span>
              </button>
              <button
                type="button"
