...
describe("ThemeProvider", () => {
  ...
  it("uses stored theme from localStorage", () => {
    localStorage.setItem("invoice-search.theme", "dark");
    renderWithTheme();
    expect(screen.getByTestId("theme").textContent).toBe("dark");
  });

  it("sets data-theme attribute on documentElement", () => {
    localStorage.setItem("invoice-search.theme", "light");
    renderWithTheme();
  ...
  it("persists theme to localStorage when toggled", async () => {
    ...
    expect(localStorage.getItem("invoice-search.theme")).toBe("dark");
  });
