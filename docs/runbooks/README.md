...
| （システム別）[Common/infra/azure/README.md](../../Common/infra/azure/README.md) | Invoice-Search / Common の**実デプロイ手順**（FastAPI / Bicep / SWA + Container Apps / Entra 認証） | — |
...
> **Azure でのはじめての場合の順番**:
> ① [azure-account-setup.md](azure-account-setup.md) → ② [docker-desktop-setup.md](docker-desktop-setup.md) → ③ [Common/infra/azure/README.md](../../Common/infra/azure/README.md)（実デプロイ）。
